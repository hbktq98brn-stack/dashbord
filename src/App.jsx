...
import EmailPulse from './components/EmailPulse'
  ...
  return (
    <div className="max-w-7xl mx-auto p-4 md:p-8 space-y-8">
      <header className="flex items-center justify-between">
        ...
        <div className="px-4 py-2 bg-white rounded-xl shadow text-sm text-gray-600">
          Данные обновляются в реальном времени (эмуляция)
        </div>
      </header>
